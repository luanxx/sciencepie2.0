...
public class CopyOfProjectActivity extends Activity{
	     ...
	     proj_src_list_view.setOnItemClickListener(new AdapterView.OnItemClickListener() {
	            ...
	            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
	            	...
	            	if(curr_proj_src != null)
	            	{
	            	  ...
	            	  proj_src_second_list_adapter = new CommonPopMenuListAdapter(CopyOfProjectActivity.this,sub_proj_src_list);
